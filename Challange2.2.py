'''Implement a class called Player that represents cricket player.The Player class should have a'''Implement a class called Player that represents cricket player.The Player class should have a
